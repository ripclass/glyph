...
/**
 * GENERATED by `supabase gen types typescript --local` (latest regen after
 * migration 010) — do not hand-edit the Database type; regenerate then
 * re-apply the compatibility tail at the bottom of this file.
 */
