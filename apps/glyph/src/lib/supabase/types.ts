...
/**
 * GENERATED by `supabase gen types typescript --local` (2026-06-12, after
 * migration 002) — do not hand-edit the Database type; regenerate instead:
 *   supabase gen types typescript --local > apps/glyph/src/lib/supabase/types.generated.ts
 * then re-apply the compatibility tail at the bottom of this file.
 */
